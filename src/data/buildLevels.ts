...
const MISSION_H1: Scene = {
  ...
  rules: [
    { type: 'exactCubeCount',    count: 5,                 requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'red',    count: 1, requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'blue',   count: 2, requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'green',  count: 1, requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'yellow', count: 1, requiredForSuccess: true },
    {
      type: 'targetShapeProjection',
      face: 'front',
      // 앞에서: 가운데 2층, 바닥 세 칸
  ...
  maxGridSize: { x: 3, y: 3, z: 3 },
  successText: '색깔 큐브와 모양이 맞았어요!\n마법의 탑이 빛나요! ✨',
  hintText: '빨강 1개, 파랑 2개, 초록 1개, 노랑 1개를 써요. 앞에서는 가운데가 2층이고, 위에서는 앞줄 두 칸과 뒷줄 두 칸이 보여야 해요.',
  hintStages: [
...
const MISSION_H2: Scene = {
  ...
  rules: [
    { type: 'exactCubeCount',    count: 6,                 requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'red',    count: 1, requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'blue',   count: 2, requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'yellow', count: 1, requiredForSuccess: true },
    { type: 'requiredColorCount', color: 'green',  count: 2, requiredForSuccess: true },
    {
      type: 'targetShapeProjection',
      face: 'front',
      // 앞에서: 2층 두 칸, 바닥 세 칸
  ...
  maxGridSize: { x: 3, y: 3, z: 3 },
  successText: '색깔 큐브와 모양이 맞았어요!\n숨어 있던 보석이 드러났어요! 💎',
  hintText: '빨강 1개, 파랑 2개, 노랑 1개, 초록 2개를 써요. 앞에서는 2층 두 칸, 위에서는 앞줄 두 칸과 뒷줄 두 칸이 보여야 해요.',
  hintStages: [
    { text: '앞에서 본 탑 모양과 위에서 본 자리를 차례대로 맞춰봐요.' },
  ],
  officialSolution: [
