...
const MISSION_M1: Scene = {
  ...
  requiredColorCount: { red: 2, blue: 1, green: 1 },
  maxCubes: 8,
  exactCubes: 4,
  maxGridSize: { x: 3, y: 3, z: 3 },
...
const MISSION_M2: Scene = {
  ...
  requiredColorCount: { red: 1, blue: 2, yellow: 1 },
  maxCubes: 8,
  exactCubes: 4,
  maxGridSize: { x: 3, y: 3, z: 3 },
...
const MISSION_M3: Scene = {
  ...
  requiredColorCount: { red: 1, blue: 2, yellow: 1, green: 1 },
  maxCubes: 9,
  exactCubes: 5,
  maxGridSize: { x: 3, y: 3, z: 3 },
...
const MISSION_H1: Scene = {
  ...
  requiredColorCount: { red: 1, blue: 2, green: 1, yellow: 1 },
  maxCubes: 9,
  exactCubes: 5,
  maxGridSize: { x: 3, y: 3, z: 3 },
...
const MISSION_H2: Scene = {
  ...
  requiredColorCount: { red: 1, blue: 2, yellow: 1, green: 2 },
  maxCubes: 10,
  exactCubes: 6,
  maxGridSize: { x: 3, y: 3, z: 3 },
...
const MISSION_H3: Scene = {
  ...
  requiredColorCount: { red: 1, blue: 2, green: 2, yellow: 2 },
  maxCubes: 12,
  exactCubes: 7,
  maxGridSize: { x: 3, y: 3, z: 3 },
